...
def tune(args,problem_size):
    ...
    hotspot_output, env = tune_kernel("calculate_temp","hotspot_improved_kernel.cu",problem_size,args,tune_params,compiler_options=cp,metrics=metrics, verbose=True)
